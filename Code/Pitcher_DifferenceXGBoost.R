...
# DIFFERENCE Model - Regression Based on Actual values and Differences from 
# the previous season. Change desired attributes in row 50.
...
Valid_wPred <- Valid_wPred[,c("player_id", "Season", "Pred_DL_length")]
setnames(Valid_wPred, "player_id", "Name")
...
test_wPred <- test_wPred[,c("player_id", "Season", "Pred_DL_length")]
setnames(test_wPred, "player_id", "Name")
